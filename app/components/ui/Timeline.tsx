...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div
			className="w-full bg-white dark:bg-slate-900 font-sans md:px-10"
			ref={containerRef}
		>
					...
					>
						<div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
							<div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-slate-900 flex items-center justify-center">
								<div className="h-4 w-4 rounded-full bg-black dark:bg-white border border-neutral-300 dark:border-neutral-700 p-2" />
							</div>
